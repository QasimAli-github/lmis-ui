        ...
        <Row >
          ...
          <Col span={4} style={{ paddingTop: "30px", paddingLeft: '20px' }}>
            ...
            <EmpDashJobSingleInfo
              jobTitle={language === 'en' ? data[0]?.lookUpValue :data[0]?.lookUpValue_Ar }
              companyName={language === 'en' ? data[0]?.companyName :data[0]?.companyName_Ar }
          ...
          <Col flex="0 1 44%" style={{ paddingTop: "65px",paddingLeft: '20px'  }}>
            <Viewjobdescription jobDescription={data[0]?.description} />
          </Col>
          <Col lg={{span: 4}} style={{ paddingTop: "65px",paddingLeft: '20px'  }}>
