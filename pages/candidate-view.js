    ...
    return (
        <div>
            ...
            <Row style={{gap:'20px'}}>
                ...
                <Col lg={4} md={{span:6, offset: 0}} sm={{span:8, offset: 0}} xs={{span:20, offset: 2}} style={{paddingTop:'30px'}}>
                ...
                <Col lg={9} md={9} sm={{span:12, offset: 0}} xs={{span:20, offset: 2}} style={{paddingTop:'30px'}}>
                    <ViewResume />
                </Col>
                <Col lg={5} md={{span:6, offset: 0}} sm={{span:18, offset: 3}} xs={{span:20, offset: 2}} style={{paddingTop:'30px'}}>
                    <Row>
