...
import { Row, Col, Tabs, Link } from 'antd';
                            ...
                            <Col lg={16}>
                                <Row>
                                    ...
                                    <Col lg={6}>
                                        <h3>By Industry</h3>
                                        <ul>
                                            <li><a href='#'>Computer Sofware</a></li>
                                    ...
                                    <Col lg={6}>
                                        ...
                                        <ul>
                                            ...
                                            <li><a href='#'>Sirte</a></li>
                                            <li><a href='#'>Al Bayda</a></li>
                                        </ul>
                                    </Col>
                                    <Col lg={6}>
                                        <h3>By Company</h3>
                                        <ul>
                                            <li><a href='#'>Hyphen</a></li>
                                            <li><a href='#'>Z Creatives</a></li>
                                            <li><a href='#'>Softpers</a></li>
                                            <li><a href='#'>GrowHawk</a></li>
