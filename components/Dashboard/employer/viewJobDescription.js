...
const Viewjobdescription = ({jobDescription, saveJobLoading, applyBtn, isApplied, applyOnThisJob}) => {
        ...
        <div className={Style.jobsMainSection}>
            <div className={Style.jobsMainBox}>
                <div className={Style.mainBoxHeader}>
                    ...
                    {
                        applyBtn && applyBtn == "true" ? <div className={Style.jobApplyBtnWrapper}>
                            <Button
                ...
                <div className={Style.jobDescriptionWrapper} dangerouslySetInnerHTML={{__html: jobDescription}}></div>
            </div>
        </div>
    );
}
