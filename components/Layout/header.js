...
const Navigation = () => {
  ...
  const logoutUser = () => {
    typeof window !== "undefined" &&
      sessionStorage.removeItem("jobhop_loggedin_user");
    typeof window !== "undefined" &&
      sessionStorage.removeItem("jobhop_loggedin_candidate_id");
    typeof window !== "undefined" &&
      sessionStorage.removeItem("jobhop_loggedin_user_id");
    typeof window !== "undefined" &&
      sessionStorage.removeItem("jobhop_loggedin_user_type");
    typeof window !== "undefined" &&
      sessionStorage.removeItem("user_first_login_jobhop");
  ...
  return (
    <div
      ...
      style={lan == "ar" ? { flexDirection: "row-reverse" } : {}}
    >
          ...
          <div className="sidebarToggleBtn">
            <Link href="">
              <span onClick={showSidebar}>
                {!sidebar ? <MenuOutlined /> : <CloseOutlined />}
              </span>
            </Link>
          </div>
        )}
              ...
              <span style={{ minWidth: "100px" }}>
                {sig && (
                  <span>
                    ...
                    {typeof window !== "undefined" &&
                      sessionStorage.getItem("jobhop_loggedin_user") &&
                      JSON.parse(sessionStorage.getItem("jobhop_loggedin_user"))
                        .user &&
                      JSON.parse(sessionStorage.getItem("jobhop_loggedin_user"))
                        .user.userFName}
                  </span>
